...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/nexelliawalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { nexelliawalletd } = gRPC.loadPackageDefinition(packageDefinition).nexelliawalletd

    this._client = new nexelliawalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
